...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.ChatViewHolder> {
    ...
    public interface MessageClickListener { void onClick(MessageModel msg); }
    ...
    public void onBindViewHolder(@NonNull ChatViewHolder holder, int position) {
        ...
        holder.itemView.setOnLongClickListener(v -> { longClickListener.onClick(msg); return true; });
    }
    ...
    @Override
    public int getItemViewType(int position) { return messageList.get(position).isSelf() ? 1 : 0; }
